...
World::World(const std::string& worldFilePath) {
    ...
    /**
     * TODO: хорошее место для улучшения. --> DONE
    ...
    while (stream.peek(), stream.good()) {
        ...
        // его скорости (vx, vy)
        stream >> centerPoint >> vectorPoint;
        ...
        // Раздельное создание объектов vectorPoint и ballVelocity сделано для большей ясности кода.
        // То же самое можно было сделать в одну строчку при вызове конструктора объекта ball.
        Velocity ballVelocity{vectorPoint};
        Ball ball(
            centerPoint,
            radius,
            ballVelocity,
